...
namespace mySLAM
{
  ...
  {
    for(size_t id = 0; id < Size; id++)  // Size == 24
    {
      data[id] = 0.0f;
    }
  }
  ...
  {
    __m128 alpha1324 = _mm_load_ps(alpha.data());
    __m128 alpha1313 = _mm_movelh_ps(alpha1324, alpha1324);
    __m128 alpha2424 = _mm_movehl_ps(alpha1324, alpha1324);

    __m128 v1a1b2a2b = _mm_load_ps(v.data() + 0);
    ...
    __m128 v3a3b4a4b = _mm_load_ps(v.data() + 4);
    ...
    __m128 v5a5b6a6b = _mm_load_ps(v.data() + 8);
